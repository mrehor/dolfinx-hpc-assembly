...
COMMAND_OPTS="--results results_${jobname}.csv -r 10 --dofs 250000"
#COMMAND_OPTS="${COMMAND_OPTS} --no-lifting"

ASSEMBLER="-t mono"
sbatch -N  1 ${LAUNCHER_OPTS} $LAUNCHER $COMMAND ${COMMAND_OPTS} ${ASSEMBLER} --overwrite
